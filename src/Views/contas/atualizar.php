...
<form action="" method="post">
    ...
    <select id="centro" name="centro">
        <?php foreach ($centros as $centro): ?>
            <option value="<?= $centro['id'] ?>" <?= $conta->getCentro_de_custo_id() == $centro['id'] ? 'selected' : '' ?>><?= $centro['nome'] ?></option>
        <?php endforeach; ?>
    </select>
    <br><br>
    ...
    <select id="fornecedor" name="fornecedor">
        <?php foreach ($fornecedores as $fornecedor): ?>
            <option value="<?= $fornecedor['id'] ?>" <?= $conta->getFornecedor_id() == $fornecedor['id'] ? 'selected' : '' ?>><?= $fornecedor['nome'] ?></option>
        <?php endforeach; ?>
    </select>
    <br><br>
    ...
    <select id="banco" name="banco">
        <?php foreach ($bancos as $banco): ?>
            <option value="<?= $banco['id'] ?>" <?= $conta->getBanco_id() == $banco['id'] ? 'selected' : '' ?>><?= $banco['nome'] ?></option>
        <?php endforeach; ?>
    </select>
    <br><br>
    ...
    <div class="input-wrapper">
        <textarea id="descricao" name="descricao" required maxlength="500" autocomplete="off"><?= $conta->getDescricao() ?></textarea>
    ...
    <div class="input-wrapper">
        <input
            ...
            value="<?= Money::centavos_para_reais($conta->getValor_em_centavos()) ?>">
        <span class="char-counter"></span>
    </div>
